...
# Remove the single patient with a gender of "X"
CKL <- CKL[CKL$Gender != "X", ]
```

OD_PCCP$Refusal[OD_PCCP$ReturnPriorityCode!=72]<- FALSE# Save Updated Data

```{r}
#| label: save_CKL

save(file = "/home2/wburr/Shawn_Research/data/CKL.rda", CKL)
```
