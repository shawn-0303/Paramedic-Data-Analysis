...
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_pickup_plot.png"),
       width = 11,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_destination_plot.png"),
       width = 9,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_age_plot.png"),
       width = 7,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_gender_plot.png"),
       width = 7,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_age_gender_plot.png"),
       width = 7,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_peryear_barplot.png"),
       width = 9,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_peryear_lineplot.png"),
       width = 9,
       height = 5)
```
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_permonth_barplot.png"),
       width = 11,
       height = 5)
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_permonth_lineplot.png"),
       width = 9,
       height = 5)
```
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_peryear_standardized_plot.png"),
       width = 9,
       height = 5)
```
...
# Save the plot as a .png in a separate folder
ggsave(file = here("scripts", "2_descriptive_stats_and_plots", "2_descriptive_statistic_plots_HPS", "CKL_calls_permonth_standardized_plot.png"),
       width = 9,
       height = 5)
```
